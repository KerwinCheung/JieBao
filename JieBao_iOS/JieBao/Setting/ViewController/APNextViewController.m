...
#import "APNextViewController.h"

@interface APNextViewController ()
...
@implementation APNextViewController
...
{
    [self.navigationController pushViewController:[NSClassFromString(@"DeviceConnectViewController") new] animated:YES];
}
