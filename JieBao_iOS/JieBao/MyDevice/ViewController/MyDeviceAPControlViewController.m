...
#import "MyDeviceAPControlViewController.h"

@interface MyDeviceAPControlViewController ()
...
@implementation MyDeviceAPControlViewController
...
- (void)nextBtnClicked
{
    [self.navigationController pushViewController:[NSClassFromString(@"MyDeviceAPControlNextViewController") new] animated:YES];
}
