...
#import "ZaoLangBengWeiShiStartTimeViewController.h"
#import "ZaoLangBengWeiShiStopTimeViewController.h"
#import "ZaoLangBengWeiShiCell.h"
#import "DeviceCommonSchulder.h"

@interface ZaoLangBengWeiShiViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ZaoLangBengWeiShiViewController
...
- (void)addBtnClicked
{
    ...
    LHWeakSelf(self);
    ZaoLangBengWeiShiStartTimeViewController *vc = [ZaoLangBengWeiShiStartTimeViewController new];
...
{
    LHWeakSelf(self);
    ZaoLangBengWeiShiStopTimeViewController *vc = [ZaoLangBengWeiShiStopTimeViewController new];
    vc.callBack = ^(NSString *obj) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZaoLangBengWeiShiCell *cell = [tableView dequeueReusableCellWithIdentifier:cellId];
    if (!cell) {
        cell = [[ZaoLangBengWeiShiCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellId];
    }
