...
//        self.bgImageView.image = [UIImage imageNamed:@"sk_kongtiao_bg"];
        ...
        self.startLb.frame = CGRectMake(CurrentDeviceSize(30), self.frame.size.height - CurrentDeviceSize(20), CurrentDeviceSize(60), CurrentDeviceSize(20));
        self.endLb.frame = CGRectMake(self.center.x + self.circelRadius/4, self.frame.size.height - CurrentDeviceSize(20), CurrentDeviceSize(60), CurrentDeviceSize(20));
        self.startLb.text = @"30%";
        self.endLb.text = @"100%";
...
- (UILabel *)startLb
{
    if (!_startLb) {
        ...
        _startLb.font = [UIFont sf_systemFontOfSize:15];
...
- (UILabel *)endLb
{
    if (!_endLb) {
        _endLb = [UILabel new];
        _endLb.font = [UIFont sf_systemFontOfSize:15];
...
-(void)ChooseWithPresent:(CGFloat)persent{
    ...
    self.commentLabel.text = [NSString stringWithFormat:@"%d ℃",30+[choose intValue]];
    self.currentValue = 30+[choose integerValue];
}
